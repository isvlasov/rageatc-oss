...
description: Guides root cause investigation before proposing fixes. Use when debugging, diagnosing failures, investigating test errors, or tracing unexpected behaviour.
---
...
5. **If 3+ Fixes Failed: Question Architecture**
   ...
   **Report BLOCKED to orchestrator with evidence before attempting more fixes.**
...
These techniques are available in this skill's references directory:

- **`references/root-cause-tracing.md`** - Trace bugs backward through call stack to find original trigger
- **`references/defence-in-depth.md`** - Add validation at multiple layers after finding root cause
